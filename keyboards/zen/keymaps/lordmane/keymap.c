...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_MODDH] = LAYOUT( \
    ...
    LC_CAPS, KC_LGUI,   KC_LALT, KC_INS, KC_ESC, LST(KC_DEL),LT_TAB,M_BSPC,LT_SPC,      KC_ENT,  KC_RALT, KC_RGUI,KC_RCTL,   KC_BSLS  \
  ),
  ...
  [_LOWER] = LAYOUT( \
    ...
    RESET,   MODDH,   QWERTY,  M_VER,   KC_CAPS, KC_ENT,  KC_TAB, KC_BSPC, KC_SPC,  KC_BSLS, KC_LEFT, KC_DOWN, KC_RGHT, M_INCL  \
  ),
